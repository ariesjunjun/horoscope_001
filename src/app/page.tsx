...
async function fetchThreads() {
  ...
  const { data, error, count } = await supabase
    .from("threads")
    .select("id, title, body, author_name, created_at, image_url", { count: "exact" });

  console.log("Raw threads from Supabase:", data);
  ...
  console.log("Threads with last_comment_at:", threadsWithLastComment);
  ...
  console.log("Paginated threads:", paginatedThreads);
